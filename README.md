...
- `controllers/driving_robot/driving_robot.cpp` → Robot controller (with explanatory comments).

## How to Run
1. Open the project in **Webots**.
2. Load the world `Parcial2.wbt`.
3. Run the controller `driving_robot.cpp` (Remove intermediate build files and build the current project).
